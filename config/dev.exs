...
config :holter, HolterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "z1T8qfKLak438RlexYqVHRswYvvWd1i+RHGLcl38L/kmr52gYMScZ+IVUZz4crfL",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:holter, ~w(--sourcemap=inline --watch)]}
  ]
...
config :holter, HolterWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/holter_web/router\.ex$"E,
      ~r"lib/holter_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
