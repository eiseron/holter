defmodule Holter.Identity.Scopes do
  ...
  tokens. Extends Eiseron.Identity.Scopes with Holter-specific scopes.
  Scopes are opaque strings of the form `<verb>:<resource>`
  ...
  @scopes Eiseron.Identity.Scopes.all() ++ @holter_scopes
