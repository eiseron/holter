  ...
  def flash(assigns) do
    ...
    >
      ...
      <button
        ...
        aria-label="close"
      >
        <HolterWeb.CoreComponents.Icon.icon name="hero-x-mark" class="icon-sm" />
      </button>
    </div>
    """
  end
  ...
  def flash_group(assigns) do
    ...
    <div id={@id} aria-live="polite" class="flash-group">
      ...
      >
        ...
        <HolterWeb.CoreComponents.Icon.icon name="hero-arrow-path" class="icon-sm animate-spin ml-1" />
      </.flash>
