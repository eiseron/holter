  ...
  def monitor do
    %Schema{
      ...
      properties: %{
        ...
        domain_check_ignore: %Schema{type: :boolean, default: false},
        ...
        domain_expires_at: %Schema{type: :string, format: :"date-time", nullable: true},
        last_domain_check_at: %Schema{type: :string, format: :"date-time", nullable: true},
