defmodule HolterWeb.Web.Delivery.WebhookChannelLive.Logs do
  ...
  def mount(%{"id" => id}, _session, socket) do
    case WebhookChannels.get(id) do
      {:ok, channel} ->
  ...
  def handle_params(params, _uri, socket) do
    ...
    path = ~p"/delivery/webhook-channels/#{socket.assigns.channel.id}/logs"
